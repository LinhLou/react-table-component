  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.icon.container} role='sortTbl'>
        <svg viewBox="0 0 320 512" onClick = {handleClickUp} height={style.icon.size} width={style.icon.size} fill={style.icon.color}><path d="M182.6 137.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8H288c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-128-128z"/></svg>
        <svg viewBox="0 0 320 512" onClick = {handleClickDown} height={style.icon.size} width={style.icon.size} fill={style.icon.color}><path d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z"/></svg>
      </div> 
      }
    </div>
  )
