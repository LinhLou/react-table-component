      ...
      <table className={style.table}>
          ...
          <tbody data-testid ='employeeList'>
            { data.rows.length!==0 ? 
              ...
              : <tr  className={style.tbody.tr} ><td colSpan={data.columns.length} className={style.tbody.td} data-testid ='noEmployeeFound' id='table_no-result'>No item corresponds to the search criteria</td></tr>
            }
          </tbody>
      </table>
  )
